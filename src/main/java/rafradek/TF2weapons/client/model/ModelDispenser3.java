...
public class ModelDispenser3 extends ModelBase {
	...
	public ModelDispenser3() {
		...
		shape1_1.addBox(-4.5F, 0.0F, 2.0F, 9, 2, 1, 0.0F);
		shape4 = new ModelRenderer(this, 52, 0);
		shape4.setRotationPoint(0.0F, 8.0F, 0.0F);
		shape4.addBox(3.5F, 1.9F, -2.5F, 1, 5, 1, -0.1F);
		shapelvl31 = new ModelRenderer(this, 0, 26);
		shapelvl31.setRotationPoint(0.0F, 5.0F, 0.0F);
		shapelvl31.addBox(-3.5F, 0.0F, -1.5F, 7, 3, 3, 0.0F);
		...
		shape1.addBox(-4.5F, 0.0F, -3.0F, 9, 2, 1, 0.0F);
		...
		shapelvl32 = new ModelRenderer(this, 20, 27);
		shapelvl32.setRotationPoint(-0.5F, 4.8F, -0.5F);
		shapelvl32.addBox(-3.5F, 0.0F, -1.5F, 8, 1, 4, 0.0F);
